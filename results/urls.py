...
urlpatterns = [
    ...
    path('bulk-upload/<int:exam_id>/preview-pdf/', bulk_scoresheet_preview_pdf, name='bulk_scoresheet_preview_pdf'),
    ...
    path('marks/preview-pdf/', marks_entry_preview_pdf, name='marks_entry_preview_pdf'),
...
urlpatterns += [
    ...
    path('exam/<int:exam_id>/subject/<int:subject_id>/sahishi/matokeo/',
         scan_results, name='scan_results'),
    ...
    path('sahishi/karatasi/<int:sheet_id>/alama/',
         scan_sheet_annotated, name='scan_sheet_annotated'),
    path('exam/<int:exam_id>/subject/<int:subject_id>/sahishi/marked-pdf/',
         scan_review_pdf, name='scan_review_pdf'),
