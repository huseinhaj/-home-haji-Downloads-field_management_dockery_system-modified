...
def generate_recommendations(stats: dict, subject_name: str = 'somo hili') -> list[str]:
    """Rule-based, deterministic recommendations in Swahili for the teacher."""
    total = stats['total']
    if total == 0:
        return ["Hakuna alama za kutosha kutoa mapendekezo."]
