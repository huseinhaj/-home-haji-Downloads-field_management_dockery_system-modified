...
(function () {
  ...
  function injectStyle() {
    ...
    var css = '' +
      ...
      '.ssc-head{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#3f5273;color:#fff;}' +
      ...
      '.ssc-ok{background:#3f5273;color:#fff;}' +
