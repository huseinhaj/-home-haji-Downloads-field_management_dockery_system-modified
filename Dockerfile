...
# ── Cache bust: 2026-09-11 (force a fresh image so STORAGES fix definitely
# lands — verifiable via the BUILD_MARKER comment in pdf_style_picker.js) ──────
ENV BUILD_DATE=2026-09-11-v3
